...
Сценарий: Печать элемента справочника "Спецификации номенклатуры" (СпецификацииНоменклатуры)
	...
	Если 'ЗначениеЗаполнено($НавигационнаяСсылка$)' Тогда
		...
		* Вывод на печать формы "Спецификация"
			...
			Если элемент формы с именем 'ПодменюПечатьОбычное_Спецификация' присутствует на форме Тогда
				И я нажимаю на кнопку с именем 'ПодменюПечатьОбычное_Спецификация'
				Если появилось предупреждение Тогда
					Тогда я вызываю исключение "Не удалось вывести на печать форму ""Спецификация"" справочника СпецификацииНоменклатуры" 
				Если имя текущей формы "ErrorWindow" Тогда
					Тогда я вызываю исключение "Не удалось вывести на печать форму ""Спецификация"" справочника СпецификацииНоменклатуры"
				Тогда открылось окно '*'
				И Я закрываю окно '*'
